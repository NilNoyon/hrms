...
$(function () {
    ...
    var element = $('ul#sidebarnav a.mega-link, ul#sidebarnav a.mega-a, ul#sidebarnav a.desk-link').filter(function () {
        return this.href == url;
    }).addClass('active').parent().addClass('active');
    
    while (true) {
        if (element.is('li')) {
            $(element).closest('.nav-item').children('a').addClass('active');
            var sub_mega_menu = $(element).closest('.sub-mega-menu').show();
            $(sub_mega_menu).closest('ul').parent().parent().siblings('ul').find(`[data-module='`+$(sub_mega_menu).attr('id')+`']`).addClass('active');
            $(sub_mega_menu).parent().addClass('border').closest('#mega').children('a').addClass('active');
            $(sub_mega_menu).parent().addClass('border').closest('.mega-dropdown-menu').addClass('in').parent().addClass('active').parent().addClass('active').children('a').addClass('active');
            element = element.closest('.mega-dropdown-menu').addClass('in').parent().addClass('active').parent().addClass('active').children('a').addClass('active');
        } else { break; }
    }
    ...
    $(document).ready(function () {
        ...
        $('#sidebarnav2 a').on('click', function (e) {
        ...
        $('#sidebarnav2 >li >a.has-arrow').on('click', function (e) {
            e.preventDefault();
        });
